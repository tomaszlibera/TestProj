...
CREATE   TRIGGER [Person].trg_BusinessEntityID_Log ON Person.BusinessEntity
AFTER INSERT
AS
	INSERT INTO dbo.DatabaseLog (Object, TSQL, XmlEvent, PostTime, DatabaseUser, Event) 
	VALUES ('BusinessEntity', 'INSERT INTO...', '<xml />', GETDATE(), USER_NAME(), 'INSERT')
GO
